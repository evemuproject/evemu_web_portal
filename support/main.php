<?php
	...
	for($i = 0; $i < $max; $i ++)
	{
		...
		?>
		<div id="supportEntry">
			<div style="float: right;">Created: <strong><?php echo date("F j, Y, g:i a", $data[$i]['timestamp']); ?></strong> by <strong><?php echo AccountManagement::GetUserName($data[$i]['accountID']); ?></strong></div>
